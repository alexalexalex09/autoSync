...
void loop()
{
    ...
    /**
     * The main loop once devices have been synced
     * Add your custom code here to do whatever you want with the peers
     * The new peer list is stored in numerical order in g_peers
     *
     */
    while (1 == 1)
    {
    ...
    /********************************************************************************************************************************************
     *                           Nothing Happens Here. If you get here, it will restart
     ********************************************************************************************************************************************/
    ESP.restart();
}